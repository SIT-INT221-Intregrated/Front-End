...
export default {
  ...
  data() {
    return {
      brandUrl: "http://172.18.0.4:3000/brands",
      colorUrl: "http://172.18.0.4:3000/colors",
      productUrl: "http://172.18.0.4:3000/products",
      updateProduct: "http://172.18.0.4:3000/updateProduct",
      updateImage: "http://172.18.0.4:3000/updateimage",
      updateProductColor: "http://172.18.0.4:3000/updateColor",
      brands: [],
      colors: [],
